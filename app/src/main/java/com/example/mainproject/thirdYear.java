...
//        spring set the search bars
        ...
        String classFall1 = prefs.getString("fall1Yr3", "");
        String classFall2 = prefs.getString("fall2Yr3", "");
        String classFall3 = prefs.getString("fall3Yr3", "");


        String classWinter1 = prefs.getString("winter1Yr3", "");
        String classWinter2 = prefs.getString("winter2Yr3", "");
        String classWinter3 = prefs.getString("winter3Yr3", "");


        String classSpring1 = prefs.getString("spring1Yr3", "");
        String classSpring2 = prefs.getString("spring2Yr3", "");
    ...
    public void backToPlanner(View view) {
        ...
        editor.putString("fall1Yr3", fallClass1);
        editor.putString("fall2Yr3", fallClass2);
        editor.putString("fall3Yr3", fallClass3);

        editor.putString("winter1Yr3", winterClass1);
        editor.putString("winter2Yr3", winterClass2);
        editor.putString("winter3Yr3", winterClass3);

        editor.putString("spring1Yr3", springClass1);
        editor.putString("spring2Yr3", springClass2);
